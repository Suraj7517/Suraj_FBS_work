class Vehicle{
	...
	void brake() {
		System.out.println("Vehicle Started Breaking");
	}
}
...
class Bike extends Vehicle{
	...
	void brake() {
		System.out.println("Bike Is Started Breaking");
	}
...
String driveMode,String parkingAssistSensors)
	...
	void brake() {
		System.out.println("Car Started Breaking");
	}
...
class Bus extends Vehicle{
	...
	void brake() {
		System.out.println("Bus Is Started Breaking");
	}
}
...
class Test{
	public static void main(String [] args){
		...
		v1=new Bike(7775,2026,"YAMAHA",2,190000,2,1,"Sports");
		v1.display();
		v1.brake();
		System.out.println();

		v1=new Car(1777,2026,"Mahindra",4,190000,"Yes","Automatic","Yes");
		v1.display();
		v1.brake();
		System.out.println();

		v1=new Bus(7775,2026,"TATA",6,1900000,50,15);
		v1.display();
		v1.brake();
	}
}