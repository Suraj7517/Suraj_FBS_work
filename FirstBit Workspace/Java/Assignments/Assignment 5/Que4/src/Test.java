...
class CricketPlayer extends Player{
	...
	void play(){
		System.out.println("The cricket player started playing cricket..");
	}
...
class FootballPlayer extends Player{
	...
	void play(){
		System.out.println("The football player started playing football..");
	}
...
class Test{
	public static void main(String[] args) {
		...
		p1=new CricketPlayer("Rohit Sharma",40,"India",700,45,20000,500,"Right","Spiner");
		p1.display();
		p1.play();
		System.out.println();
		
		p1=new FootballPlayer("Cristiano",55,"Portugal",2000,7,5000,"Attacking");
		p1.display();
		p1.play();
		System.out.println();
	}
