...
class Artist {
	...
	void starArting(){
		System.out.println("Artist started showing his art");
	}
}
class Painter extends Artist{
	...
	void starArting(){
		System.out.println("Painter started Painting");
	}
...
class Musician extends Artist{
	...
	void starArting(){
		System.out.println("Musician started making music");
	}
...
class Actor extends Artist{
	...
	void starArting(){
		System.out.println("Artist started his acting");
	}
...
class test{
	public static void main(String[] args) {
		...
		ar1=new Painter("Ramesh",66,"Vyang","Pencil",1099);
		ar1.display();
		ar1.starArting();
		System.out.println();
		
		ar1=new Musician("Dev",76,"Piano","abs",543);
		ar1.display();
		ar1.starArting();
		System.out.println();
		
		ar1=new Actor("Salman Khan",50,"Bollywood",700);
		ar1.display();
		ar1.starArting();
		System.out.println();
	}
